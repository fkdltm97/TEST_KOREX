      ...
      //만약에 필터 모달을 키고 싶으면 아래 함수 호출하시면됩니다.
        const phoneModal = () =>{
          ...
          setModalOption({
              ...
              setShow:offModal,
              title:"휴대폰번호 변경",
              content:{type:"text",text:`휴대번호가\n정상적으로 변경되었습니다.`,component:""},
              submit:{show:false , title:"로그아웃" , event : ()=>{offModal(); }},
              cancle:{show:false , title:"취소" , event : ()=>{offModal(); }},
              confirm:{show:false , title:"확인" , event : ()=>{offModal(); }},
              confirmgreen:{show:true , title:"확인" , link:"/MyProfileSetting", event : ()=>{offModal(); }}
    ...
    return (
        <>
          ...
          <Container>
              ...
              <PhoneChange phoneModal={phoneModal} cerModal={cerModal}/>
