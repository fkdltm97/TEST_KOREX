...
export default function Condition({setMap,setFilter,setVisit,setVCal,value, type, type2}) {
    ...
    return (
        <Container>
          <WrapCondition>
            ...
            <ConditionList>
            {
            ConditionListItem.map((value) => {

              const type=()=>{
                if(value.type == "orange") {
                  return "#fe7a01"
                }else if(value.type == "gray") {
                  return "#707070"
              ...
              return(
                <ConditionChangeList setMap={setMap} setFilter={setFilter} setVisit={setVisit} setVCal={setVCal} value={value} type={type} type2={type2}/>
              )
            })
          }
        </ConditionList>
