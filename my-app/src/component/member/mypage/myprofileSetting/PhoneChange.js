...
export default function EmailChange({phoneModal,cerModal}) {
...
const pageLoader = () =>{
  switch (pageIndex) {
    case 0: return <PhoneChangeFirst updatePageIndex={updatePageIndex} cerModal={cerModal}/>;
    case 1: return <PhoneChangeSecond updatePageIndex={updatePageIndex} phoneModal={phoneModal}/>;
