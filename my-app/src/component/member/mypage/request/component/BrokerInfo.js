...
export default function SideBarBrokerDetailCont({historyInfo,updatePageIndex,setHistoryInfo, setMap}) {
          ...
          <TopContent>
            <ProfileDetail>
                ...
                <BottomBox>
                  <LeftContent>
                    <ItemInfo>
                      <ComName>럭키공인중개사</ComName>
                      <Name>홍길동</Name>
                      <Address onClick={() =>{setMap(true)}}>강남구 논현동 104-5</Address>
                      <SellList>
